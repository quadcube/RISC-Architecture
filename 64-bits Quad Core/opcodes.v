...
//Multi-core instruction & datapath instruction
`define MOVC1	6'd63
`define MOVC2	6'd62
`define XCHG1	6'd61
...
`define	PC3	18'b000000000000010010
`define	DR3	18'b101000000000000000
`define	IR3	18'b110000000000000000
`define	R0_2	18'b000000000000000000
`define R1_2	18'b000000000000000001
`define	R2_2	18'b000000000000000010
`define	R3_2	18'b000000000000000011
`define	R4_2	18'b000000000000000100
`define	R5_2	18'b000000000000000101
`define	R6_2	18'b000000000000000110
`define	R7_2	18'b000000000000000111
`define	R8_2	18'b000000000000001000
`define	R9_2	18'b000000000000001001
`define	R10_2	18'b000000000000001010
`define	R11_2	18'b000000000000001011
`define	R12_2	18'b000000000000001100
`define	R13_2	18'b000000000000001101
`define	R14_2	18'b000000000000001110
`define	R15_2	18'b000000000000001111
`define	R16_2	18'b000000000000010000
`define	R17_2	18'b000000000000010001

`define	PC4	18'b000000000000010010
`define	DR4	18'b101000000000000000
`define	IR4	18'b110000000000000000
`define	R0_3	18'b000000000000000000
`define R1_3	18'b000000000000000001
`define	R2_3	18'b000000000000000010
`define	R3_3	18'b000000000000000011
`define	R4_3	18'b000000000000000100
`define	R5_3	18'b000000000000000101
`define	R6_3	18'b000000000000000110
`define	R7_3	18'b000000000000000111
`define	R8_3	18'b000000000000001000
`define	R9_3	18'b000000000000001001
`define	R10_3	18'b000000000000001010
`define	R11_3	18'b000000000000001011
`define	R12_3	18'b000000000000001100
`define	R13_3	18'b000000000000001101
`define	R14_3	18'b000000000000001110
`define	R15_3	18'b000000000000001111
`define	R16_3	18'b000000000000010000
`define	R17_3	18'b000000000000010001
